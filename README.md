...
- **Unified Rules**: Standards for creation and review are located in `.agents/rules/standards.md`.
- **Automation Skills**: Automated tools for note reviewing and scaffolding are available in `.agents/skills/`.
- **Project Mandates**: Root-level `CLAUDE.md` and `AGENTS.md` ensure consistent agent behavior across all sessions.
